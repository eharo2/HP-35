...
extension DataModel {
    var hp45Keys: [Key] {
        [
            ...
            Key(type: .lightGray, ops: [.sto, .toDMS], "STO", "", 14, 0, 0,
                                       Sym.right, "D.MS", 8, 12, 0),
            Key(type: .lightGray, ops: [.rcl, .fromDMS], "RCL", "", 14, 0, 0,
                                       "D.MS", Sym.right, 12, 8, 0),
            Key(type: .gray, ops: [.percentage, .delta], "%", "", 16, 0, 0,
                                                         "", "\(Sym.delta)%", 0, 14, 2),
            // Row 4
            Key(type: .lightGrayLarge, ops: [.enter, .deg], "ENTER \(Sym.up35)", "", 17, 0, 0,
                                                            "DEG", "", 13),
            Key(type: .lightGray, ops: [.chs, .rad], "CHS", "", 14, 0, 0,
                                                     "RAD", "", 13),
            Key(type: .lightGray, ops: [.eex, .grd], "EEX", "", 14, 0, 0,
                                                     "GRD", "", 13),
            Key(type: .lightGray, ops: [.clrX, .clr], "CL ", Sym.x, 14, 17, 2,
                                                      "CLEAR", "", 13),
            Key(type: .lightGray, ops: [.substract], "", Sym.substract, 0, 24, 2),
            Key(type: .white, ops: [.digit("7"), .cmIn], "7", "", 17, 0, 0, "cm/in", "", 14),
            Key(type: .white, ops: [.digit("8"), .kgLb], "8", "", 17, 0, 0, "kg/lb", "", 14),
            Key(type: .white, ops: [.digit("9"), .ltrGal], "9", "", 17, 0, 0, "ltr/gal", "", 14),
