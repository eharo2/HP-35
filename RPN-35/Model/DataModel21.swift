    ...
    var hp21Keys: [Key] {
        [
            ...
            Key(type: .black, ops: [.clrX, .clr], "CL", Sym.x, 14, 17, 2,
                                                      "", "CLR", 0, 12, 2),
            // Row 5
            Key(type: .white, ops: [.substract, .mSubstract], "", Sym.substract, 0, 16, 2,
            ...
            Key(type: .white, ops: [.divide, .mDivide], "", Sym.divide, 0, 16, 2,
